...
log.logger = log.get_logger(out_dir)
...
model_weights_path = "/home/mizutani/projects/RF/runs/20251216_225748/model_weights_20251216_225748.pth"
...
teacher_df.to_csv(stamp(f"teacher_{run_id}.csv"), index=False)
...
loadfile = torch.load(model_weights_path, weights_only=False, map_location=device)
...
result_df.to_csv(stamp(f"result_ordinary_{run_id}.csv"), index=False)
